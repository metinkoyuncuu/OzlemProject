    ...
    <footer className="w-full bg-white relative border-t border-theme-blue/30">
      ...
      <div className="container mx-auto max-w-[1140px] px-4 py-8 md:py-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-0">
          ...
          <div>
            <a href="tel:05510102339" className="flex items-center gap-3 border-2 border-theme-blue text-theme-blue px-8 py-3 rounded-full hover:bg-theme-blue hover:text-white transition-all duration-300 font-bold text-lg group shadow-sm hover:shadow-lg">
